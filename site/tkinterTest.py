...
#  -Convertir el programa en un exe para distribuir
...
win.title("Zoom Automatic Scheduler")
#win.state('zoomed')
...
def generateSchedule(hora, dia, materia):
    ...
    if dia == "Lunes":
        ...
        print("Entro al if del dia")
        schedule.every().sunday.at(hora).do(logIn, materia)
...
matDict = {"Algebra I (Lunes)":"99870189", "Algebra I (Jueves)": "225983161", "Analisis I":"730164746", "Intro a Ing.":"818743518", "Filosofia":"727872670", "Quimica":"811928002"}

#-----------------------------------------GENERADOR---------------------------------------------
#emptyLabel1 = tk.Label(win, text="").grid(row=11, column=1)
